...
<head>
    <title>Customer History - UTMS</title>
...
<body class="text-white h-screen">
    <div class="w-full h-full bg-[#18191a] pb-10">
        ...
        <div class="navbar bg-[#242526] shadow-2xl">
            ...
            <div class="flex-none">
                <ul class="menu menu-horizontal pl-1 pr-2 flex flex-row items-center">
                    ...
                    <li><a href="./customer-history.php" class="text-[#1bd1a4]">Customer History</a></li>
        ...
        <div class="w-[80%] mx-auto flex flex-col justify-center items-center pt-20">
            ...
            <h1 class="font-bold text-3xl mb-10">Customer History</h1>

            <div class="w-[80%] mx-auto flex flex-row gap-5 mb-10">
                <div class="card bg-white text-black w-96 py-9">
                    <div class="card-body flex flex-col items-center justify-center">
                        <h2 class="font-bold text-xl">Purchased Tickets</h2>
                      <h2 class="card-title font-bold text-5xl text-[#1bd1a4]">10</h2>
                    </div>
                  </div> 
                <div class="card bg-white text-black w-96 py-9">
                    <div class="card-body flex flex-col items-center justify-center">
                        <h2 class="font-bold text-xl text-center">Total Amount for Purchasing Ticket</h2>
                      <h2 class="card-title font-bold text-5xl text-[#1bd1a4]">1000 <span>Taka</span></h2>
                    </div>
                  </div>    
                  <div class="card bg-white text-black w-96 py-9">
                    <div class="card-body flex flex-col items-center justify-center">
                        <h2 class="font-bold text-xl">Cancled Tickets</h2>
                      <h2 class="card-title font-bold text-5xl text-[#FF0000]">0</h2>
                    </div>
                  </div>            
            </div>
