                ...
                <div class="card flex-shrink-0 w-[45%] mx-auto shadow-2xl bg-base-100">
                    <div class="card-body">
                      <div class="form-control">
                        ...
                        <input type="text" placeholder="Ticket Id" class="input input-bordered" />
                      </div>
                      <div class="form-control">
                        <label class="label">
                      ...
                      <div class="form-control">
                        ...
                        <input type="text" placeholder="Status" class="input input-bordered" />
                      </div>
                      <div class="form-control">
                        <label class="label">
                          <span class="label-text">Priority</span>
                        </label>
                        <input type="text" placeholder="Priority" class="input input-bordered" />
                      </div>
                      <div class="form-control">
                        <label class="label">
                          <span class="label-text">Total amount of Ticket</span>
                        </label>
                        <input type="text" placeholder="Total Amount of Ticket" class="input input-bordered" />
                      </div>
                      <div class="form-control">
                        <label class="label">
